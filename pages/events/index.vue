  ...
  <div>
    <v-container>
      ...
      <div class="text--lighten-2 mt-4 text-body-1 text-center">
        ...
        <p>The zoom link is <a href="https://us04web.zoom.us/j/5811597930?pwd=UCtVSGZoU1d0V0Q3WEJ3QXJTVEQ0UT09">https://us04web.zoom.us/j/5811597930?pwd=UCtVSGZoU1d0V0Q3WEJ3QXJTVEQ0UT09</a>.</p>
      </div>
    </v-container>
...
export default {
  ...
  data () {
    return {
      seasons: ['Fall 2024', 'Summer 2024', 'Spring 2024', 'Fall 2023', 'Summer 2023', 'Spring 2023', 'Fall 2022', 'Fall 2021'],
      currentSeason: 'Fall 2024'
    }
  },
  head () {
    return {
